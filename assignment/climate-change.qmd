...
**Answer 4:**
```{r}
url <- "https://data.giss.nasa.gov/gistemp/graphs/graph_data/Global_Mean_Estimates_based_on_Land_and_Ocean_Data/graph.tx"
...
temp <-  read.table(url, 
                    ...
                    na = c("-1", "-99.99"), 
                    skip = 4)  # Skips the first few lines (e.g., metadata) before actual data
temp
